        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FlightbookingAvani>(entity =>
            {
                entity.HasKey(e => e.Bid)
                    .HasName("PK__flightbo__DE90ADE79BDB1F98");
                ...
                entity.HasOne(d => d.FlightNoNavigation)
                    ...
                    .HasConstraintName("FK__flightboo__fligh__1B5E0D89");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.FlightbookingAvanis)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__flightboo__userI__1A69E950");
            });
            ...
            {
                entity.HasKey(e => e.AId)
                    .HasName("PK__HarshitE__DE518A06C4785C55");
                ...
                entity.HasOne(d => d.Emp)
                    .WithMany(p => p.HarshitEmpAbouts)
                    .HasForeignKey(d => d.EmpId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__HarshitEm__empId__14B10FFA");
            });
            ...
            {
                entity.HasKey(e => e.Userid)
                    .HasName("PK__login_aw__CBA1B2577AA5BD9D");
